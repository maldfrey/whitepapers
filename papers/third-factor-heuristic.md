...
Applied systematically, the model reveals why obvious reforms fail again and again. More importantly, it points to a deeper civilizational pattern: humans have a profound psychological need to believe in something larger than raw empirical reality. When that belief system collides with evidence, third factors emerge as protective patches. What looks like irrational policy is often highly rational optimization for status, identity coherence, moral comfort, or coalition stability. Because these third factors tend to deliver short-term psychological or social payoffs while deferring real costs into the future, societies can appear functional for decades while quietly consuming their own seed corn.  
...
1. Identify the **core negative** — a clear, legitimate desire or problem that cannot be satisfied through ordinary, rule-abiding means. Assign it **\-1**.  
2. Observe the **chosen action** — usually an illegitimate, self-destructive, or counterproductive step (lying in an argument, stealing, implementing a policy known to worsen the original problem, etc.).  
3. List the two obvious, surface-level effects of that action:  
...
4. Perform the arithmetic: **\+1 and \-1 \= net still \-1** (or worse).
...
This dynamic is explored at length in the earlier paper *Conceit-Anchored Nihilism*. Once external anchors (tradition, rule of law, measurable results) have been dissolved, the remaining source of meaning is internal elevation: “I have seen through the illusions that still bind ordinary people.” Maintaining that sense of moral or intellectual superiority becomes the dominant third factor. Actual results become secondary; the internal identity must be preserved at all costs.  
...
A policy or cultural norm can appear highly successful today precisely because it borrows from the future. It consumes accumulated social trust, fiscal capacity, family formation rates, institutional competence, and demographic stability. The short-term “win” is real — political popularity, moral applause, immediate psychological comfort — but the costs are deferred. What looks adaptive in the present is often maladaptive over longer time horizons.  
This is the seed-corn problem: societies eat their future capacity to pay for today’s psychological or political rewards. The Darwinian filter is slow but merciless. By the time the bill comes due, the people who made the original choices are often no longer in power, and the next generation inherits both the problems and the belief systems that make solving them difficult.  
